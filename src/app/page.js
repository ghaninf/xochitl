    ...
    <>
      ...
      <main className="relative min-h-screen flex flex-col items-center justify-between">
        ...
        <section className='relative w-full'>
          <SubscribeForm />
          <div className='font-black max-md:ml-[35px] max-md:-mt-10 w-[calc(100%-35px)] p-9 md:mb-20 md:w-[calc(50%-20px)] md:pl-[128px] md:pr-[182px] md:pt-[90px] md:pb-[223px] md:float-right relative box-border bg-[#ECECEC]'>

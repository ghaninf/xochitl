...
export default function BannerImage() {
  return(
    <section className="relative w-full max-w-full max-h-[1440px] overflow-hidden flex flex-col md:h-[1028px] bg-contain">
      <div className="absolute w-[150%] md:w-full top-0 md:-top-20 left-0 right-0 md:py-[810px] ">
        <Image
          fill
          placeholder={"blur"}
          quality={100}
      ...
      <div className="absolute max-md:left-8 max-md:bottom-0 md:bottom-[267px] md:right-[136px]">

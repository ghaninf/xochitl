...
export default function VideoSection() {
  return(
    <section className="relative w-full md:mt-20 md:h-[667px] lg:h-[550px] flex flex-col md:flex-row-reverse bg-[color:var(--secondary-color)]">
      ...
      <div className="basis-1/2 md:basis-full flex justify-start md:items-center lg:items-start p-10 md:px-20 md:py-28">
        <div className="md:basis-8/12 lg:basis-5/12 md:pt-10 lg:pt-0">
          <div className="relative flex flex-col gap-y-[10px] font-white">
            <h2 className="font-resolute text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[55px] tracking-[2px] xl:leading-[130%]">SIN MIEDO</h2>
            <h2 className="font-resolute text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[55px] tracking-[2px] xl:leading-[130%]">A NADA</h2>
            ...
            <div className="relative mt-4 group w-fit pb-1 box-border cursor-pointer before:w-full before:border-b-[3px] before:border-pink-500 before:absolute before:-bottom-1 before:left-0 before:transform before:scale-x-100">

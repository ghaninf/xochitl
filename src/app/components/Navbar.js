  ...
  return(
    <nav id="container-navbar" className="fixed top-0 left-0 right-0 z-50">
      <div id="navbar" className="relative px-[33px] py-2 md:py-4 flex flex-row flex-nowrap justify-between items-center ease-in-out duration-300">
        <ul className={`max-lg:hidden relative lg:px-2 xl:px-6 2xl:px-[30px] w-full flex flex-row flex-nowrap lg:gap-x-3 2xl:gap-x-[18px] font-resolute text-[17px] tracking-[1px] leading-[26px] font-normal ${listColorNav[props?.page].text}`}>

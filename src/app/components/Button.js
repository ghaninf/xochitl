  ...
  if (props.typeButton === 'button') {
    return(
      <button
        ...
        className={`relative w-fit min-w-[100px] font-version font-medium text-[15px] h-fit px-8 py-3.5 leading-[26px] tracking-[1.5px] flex flex-nowrap gap-x-1 justify-center items-center box-border rounded-lg cursor-pointer border border-transparent

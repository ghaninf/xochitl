  ...
  return(
    <nav className="fixed top-0 left-0 right-0 z-50">
      <div className="relative px-[33px] py-[8px] flex flex-row flex-nowrap justify-between items-center">
        <ul className="relative px-[30px] w-full flex flex-row flex-nowrap gap-x-[18px] font-resolute text-[17px] tracking-[1px] leading-[26px] font-normal text-white">
          <li><Link href={'#'}>XÓCHITL</Link></li>
          <li><Link href={'#'}>PROPUESTAS</Link></li>
          <li><Link href={'#'}>EVENTOS</Link></li>
          <li><Link href={'https://xochitl.io'} target="_blank" rel="noopener" >TIENDA</Link></li>
        </ul>
        <Logo />
